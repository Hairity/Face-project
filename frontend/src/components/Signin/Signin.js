...
const Signin = ({ onRouteChange }) => {
  return (
    ...
    <div>
      <div className="sans-serif w-90 white mw6 center relative cover bg-top mt2" style={{ backgroundImage: `url("https://artificialintelligence-news.com/wp-content/uploads/sites/9/2019/01/ai-artificial-intelligence-emotion-detection-facial-speech-research-paper.jpg")`}}>
      ...
      <div className="relative pa4 pa5-m">
        ...
        <form action="" id="login" className="">
          ...
          <div>
            <button 
            className="input-reset db w-100 light-gray f6 b ttu tracked pv3 ph3 pointer bg-blue bn br-pill"
        ...
        <div className="tc b f6 mt4 o-70 glow pa2 i">
          New Member? <a className="white" href="/signin">Register</a>
        </div>
      </div>
    </div>
